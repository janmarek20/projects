...
class Scoreboard:
    ...
    def prep_score(self):
        """Przekształcenie pnktacji na wygenerowany obraz."""
    ...
    def prep_high_score(self):
        ...
        # Wyświetlenie najlepszego wyniku w grze u góry na środku ekranu.
        self.high_score_rect = self.high_score_image.get_rect()
        self.high_score_rect.centerx = self.screen_rect.centerx
        self.high_score_rect.top = self.score_rect.top

    def check_high_score(self):
        """Sprawdzenie, czy mamy nowy najlepszy wynik, dotąd w grze."""
    ...
    def prep_level(self):
        ...
        # Numer poziomu jest wyświetlany pod aktualna punktacją.
